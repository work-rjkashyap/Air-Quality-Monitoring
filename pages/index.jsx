...
export default function Home() {
  ...
  const showList = (data) => {
    ...
    return sortedArray.map((val,key) => ( 
      ...
      <div key={key} style={ActiveCard==val[0]?MainBanner:null} className="cursor-pointer transition-all m-2 w-[95%] md:w-[23%] p-2 bg-[#ffffff] rounded ">
      <Card AQI={val[1]}   CityName={val[0]} onClick={() => setActiveCard(val[0])} />
      </div>
    ));
  };
  ...
  return (
    <div className="bg-[#040714]">
      ...
      <div className="h-auto flex-wrap bg-black flex flex-col md:flex-row justify-center md:justify-between p-3">
        <h1 className="text-white flex justify-center text-xl font-bold">Air Quality Monitoring</h1>
